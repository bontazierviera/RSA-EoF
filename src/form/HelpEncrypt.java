 ...
 * @author Zierviera
 */
public class HelpEncrypt extends javax.swing.JFrame {
Dimension UM = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public HelpEncrypt() {
        initComponents();
        this.setTitle("Encrypt Help Form");
...
lblGambar.setIcon(imageIcon);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How To Encrypt File");
        ...
        jLabel5.setText("1. Choose file which one to encrypt.");
        ...
        jLabel7.setText("3. Choose Public Key for encrypt key.");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(240, 240, 240));
        jLabel9.setText("4. Click button \"Process\" to start encryption.");
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bgHelpSub1, javax.swing.GroupLayout.PREFERRED_SIZE, 275, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpEncrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpEncrypt().setVisible(true);
            }
        });
    }
