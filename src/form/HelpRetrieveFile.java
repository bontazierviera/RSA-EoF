 ...
 * @author Zierviera
 */
public class HelpRetrieveFile extends javax.swing.JFrame {
Dimension UM = Toolkit.getDefaultToolkit().getScreenSize();
    /**
     * Creates new form Help
     */
    public HelpRetrieveFile() {
        initComponents();
        this.setTitle("Retrieve Help Form");
...
lblGambar.setIcon(imageIcon);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How To Retrieve File");
        ...
        jLabel5.setText("1. Choose embedded image.");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("2. Save as location");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(240, 240, 240));
        jLabel9.setText("3. Click button \"Process\" to start retrieve file.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpRetrieveFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpRetrieveFile().setVisible(true);
            }
        });
    }
