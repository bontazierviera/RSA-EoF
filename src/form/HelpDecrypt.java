 ...
 * @author Zierviera
 */
public class HelpDecrypt extends javax.swing.JFrame {
Dimension UM = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public HelpDecrypt() {
        initComponents();
        this.setTitle("Decrypt Help Form");
...
lblGambar.setIcon(imageIcon);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How To Decrypt File");
        ...
        jLabel5.setText("1. Choose file which one to decrypted.");
        ...
        jLabel7.setText("3. Choose Private Key for decrypt key.");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(240, 240, 240));
        jLabel9.setText("4. Click button \"Process\" to start decryption.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpDecrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpDecrypt().setVisible(true);
            }
        });
    }
